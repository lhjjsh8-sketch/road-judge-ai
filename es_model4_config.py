...
default_hooks = dict(
    checkpoint=dict(
        ...
        interval=1,
        max_keep_ckpts=1,
        out_dir='/content/training_temp_B',
        save_best='acc/mean1',
        save_last=False,
        type='CheckpointHook'),
...
test_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='/content/drive/MyDrive/cv_final/val.txtB',
...
train_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='/content/drive/MyDrive/cv_final/train.txtB',
        data_prefix=dict(video=''),
        pipeline=[
            dict(io_backend='disk', type='DecordInit'),
            dict(
...
work_dir = '/content/training_temp_B'
