...
launcher = 'none'
load_from = '/content/drive/MyDrive/cv_final/work_dirs/model1_place_zzin/best_acc_top1_epoch_49.pth'
model = dict(
    backbone=dict(
        conv1_kernel=(
            5,
...
test_dataloader = dict(
    batch_size=32,
    dataset=dict(
        ann_file='/content/val_place.txt',
...
train_dataloader = dict(
    batch_size=32,
    dataset=dict(
        ann_file='/content/train_place.txt',
...
work_dir = '/content/drive/MyDrive/cv_final/work_dirs/model1_place_FT2_Plus3'
