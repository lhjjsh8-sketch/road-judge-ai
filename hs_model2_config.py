...
launcher = 'none'
load_from = '/content/drive/MyDrive/cv_final/work_dirs/model2_place_feature_FL/best_acc_top1_epoch_48.pth'
model = dict(
    backbone=dict(
        conv1_kernel=(
            5,
...
test_dataloader = dict(
    batch_size=32,
    dataset=dict(
        ann_file='/content/val_accident_feature.txt',
...
train_dataloader = dict(
    batch_size=32,
    dataset=dict(
        ann_file='/content/train_accident_feature.txt',
...
work_dir = '/content/drive/MyDrive/cv_final/work_dirs/model2_place_feature_FT2_Plus3'
