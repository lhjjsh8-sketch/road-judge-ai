...
launcher = 'none'
load_from = '/content/drive/MyDrive/cv_final/work_dirs/model3_object_a_feature_FT2_Plus3/best_acc_top1_epoch_20.pth'
model = dict(
    backbone=dict(
        conv1_kernel=(
            5,
...
test_dataloader = dict(
    batch_size=32,
    dataset=dict(
        ann_file='/content/val_object_a_feature.txt',
...
train_dataloader = dict(
    batch_size=32,
    dataset=dict(
        ann_file='/content/train_object_a_feature.txt',
...
work_dir = '/content/drive/MyDrive/cv_final/work_dirs/model3_object_a_feature_FT3_Extreme'
